...
<body>
    ...
    <section id="banner">
        <div class="inner">
            ...
            <form action="yourActionServlet" method="post"> <!-- Replace 'yourActionServlet' with your actual servlet URL -->
                <input id="login" name="password" type="password" placeholder="인증 키 입력 후 엔터"><br>
                <button type="submit" class="button big scrolly">Learn More</button>
            </form>
        </div>
    </section>
